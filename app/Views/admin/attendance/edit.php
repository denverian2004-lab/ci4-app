...
<div class="card" style="max-width:650px;">
    ...
    <div class="card-body">
        <form action="/admin/attendance/update/<?= $record['id'] ?>" method="POST">
            <?= csrf_field() ?>
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="time" name="time_in" class="form-control" value="<?= esc($record['time_in']) ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Time Out</label>
                    <input type="time" name="time_out" class="form-control" value="<?= esc($record['time_out']) ?>">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="remarks" class="form-control" value="<?= esc($record['remarks']) ?>">
                </div>
