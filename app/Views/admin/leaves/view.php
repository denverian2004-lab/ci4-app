    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="/admin/leaves" class="btn btn-sm btn-outline-secondary">
...
<?php if ($balance): ?>
<div class="col-12">
    <div class="alert alert-info py-2 d-flex gap-4 flex-wrap">
        <span><i class="bi bi-calendar2-check me-1"></i><strong>Leave Balance (<?= date('Y') ?>)</strong></span>
        <span>Allocated: <strong><?= $balance['allocated_days'] ?> days</strong></span>
        <span>Used: <strong class="text-danger"><?= $balance['used_days'] ?> days</strong></span>
        <span>Remaining: <strong class="text-success"><?= $balance['remaining_days'] ?> days</strong></span>
    </div>
</div>
<?php endif; ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if ($leave['status'] === 'Pending'): ?>
                    ...
                    <form action="/admin/leaves/approve/<?= $leave['id'] ?>" method="POST" class="mb-2">
                        <?= csrf_field() ?>
                    ...
                    <form action="/admin/leaves/reject/<?= $leave['id'] ?>" method="POST">
                        <?= csrf_field() ?>
